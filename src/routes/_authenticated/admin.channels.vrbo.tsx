...
export const Route = createFileRoute("/_authenticated/admin/channels/vrbo")({
  component: VrboPage,
});
    ...
    <div className="space-y-5">
      ...
      <AdminPanel title="Coming next" description="Demo note for your client meeting">
        <p className="text-sm leading-relaxed text-brand-charcoal/85">
          Reserved for VRBO. Live inventory and bookings will appear here after channel connection —
          same layout as Booking.com.
        </p>
