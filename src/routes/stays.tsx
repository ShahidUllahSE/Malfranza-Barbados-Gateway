            ...
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4">
              ...
              <div className="relative shrink-0">
                ...
                <select
                  ...
                  className="appearance-none rounded-xl border border-border bg-white py-2.5 pl-3 pr-9 text-sm text-brand-charcoal outline-none focus:border-brand-sage"
                >
...
function ApartmentCard({ apt }: { apt: Apartment }) {
  ...
  return (
    <article className="flex flex-col overflow-hidden rounded-2xl border border-border bg-white shadow-card transition-shadow hover:shadow-card-hover">
